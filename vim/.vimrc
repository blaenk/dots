...
" mappings
nnoremap <silent> <leader>u :Unite -toggle -auto-resize -buffer-name=files file_rec/async:!<CR>
...
" call unite#custom#source('file,file/new,buffer,file_rec', 'sorters', 'sorter_rank')
