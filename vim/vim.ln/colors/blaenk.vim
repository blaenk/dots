...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  " zsh
  call <SID>X("zshDeref", s:light_green, "", "")
  call <SID>X("zshSubst", s:light_green, "", "")
  call <SID>X("zshConditional", s:purple, "", "")
  call <SID>X("zshRepeat", s:purple, "", "")
  call <SID>X("zshVariableDef", s:aqua, "", "")
  call <SID>X("zshCommands", s:dark_red, "", "")
  call <SID>X("zshFunction", s:blue, "", "")
  call <SID>X("zshKeyword", s:purple, "", "")
  call <SID>X("zshDelimiter", s:purple, "", "")
